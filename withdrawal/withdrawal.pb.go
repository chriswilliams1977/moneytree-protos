...
var fileDescriptor_729e0e9b3824e84b = []byte{
	...
	0x97, 0x9d, 0x2a, 0x1e, 0x50, 0x8f, 0x6a, 0x34, 0x5e, 0x3c, 0x54, 0x13, 0x8d, 0x07, 0xc9, 0x74,
	0xfa, 0x09, 0x93, 0xb4, 0x1d, 0x9c, 0x99, 0x42, 0x7c, 0x06, 0xdf, 0xc6, 0xf7, 0xf0, 0x9d, 0x0c,
	...
	0x7b, 0x85, 0xa6, 0x62, 0xfe, 0xe7, 0x2b, 0x99, 0xdd, 0xc2, 0x7e, 0xce, 0x67, 0xa7, 0x8f, 0xc7,
	0x53, 0x61, 0x66, 0x79, 0x44, 0xb9, 0x4c, 0x03, 0x3e, 0x53, 0x42, 0x2f, 0x45, 0x92, 0x08, 0x96,
	0xea, 0xc3, 0x93, 0xf1, 0x38, 0xd8, 0x7a, 0xfc, 0xb7, 0x1f, 0x44, 0x07, 0xa5, 0x4d, 0xd4, 0xb4,
	0xd0, 0xd1, 0x67, 0x00, 0x00, 0x00, 0xff, 0xff, 0x5d, 0xc0, 0xea, 0xbe, 0xd6, 0x02, 0x00, 0x00,
}
...
type WithdrawalServiceClient interface {
	...
	GetWithdrawal(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error)
}
...
func (c *withdrawalServiceClient) GetWithdrawal(ctx context.Context, in *Request, opts ...client.CallOption) (*Response, error) {
	req := c.c.NewRequest(c.serviceName, "WithdrawalService.GetWithdrawal", in)
	out := new(Response)
	err := c.c.Call(ctx, req, out, opts...)
	if err != nil {
		return nil, err
...
type WithdrawalServiceHandler interface {
	...
	GetWithdrawal(context.Context, *Request, *Response) error
}
...
func (h *WithdrawalService) GetWithdrawal(ctx context.Context, in *Request, out *Response) error {
	return h.WithdrawalServiceHandler.GetWithdrawal(ctx, in, out)
}
